...
use InspiredMinds\IncludeInfoBundle\EventListener\ChildRecordCallbackListener;
...
$GLOBALS['TL_DCA']['tl_content']['list']['sorting']['child_record_callback'] = [ChildRecordCallbackListener::class, 'onChildRecordCallback'];
